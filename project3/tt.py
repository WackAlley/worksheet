...
if __name__ == "__main__":
    ...
    if train:
        ...
        timesteps_per_generation = int(2e2)  # Trainingsschritte pro Generation
        ...
        for generation in range(total_generations):
            ...
            print(model.env.get_attr("opponent"))
            ...
            env.opponent = ModelOpponent(opponent_model)  # Setze den neuen Gegner
